        ...
        return (
            <ScrollView bounces={false} contentContainerStyle={styles.scrollContent}>
                ...
                {!isSearching && hasSearchResults && searchResults && (
                    <SearchResultsSection linkingId={linkingId} onLink={handleLinkRecord} results={searchResults} />
                )}

                {/* Error (only show when not searching and no results) */}
                {!isSearching && !hasSearchResults && error && <Text style={styles.errorText}>{error}</Text>}
