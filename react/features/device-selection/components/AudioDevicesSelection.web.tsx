...
class AudioDevicesSelection extends AbstractDialogTab<IProps, {}> {
    ...
    override render() {
        ...
        const isAudioSettingsEnabled = Boolean(
        ...
        const shouldDisplayAdvancedAudioSettingsCheckboxes =
            !hideNoiseSuppression && !iAmVisitor && isAdvancedAudioSettingsConfigEnabled && Boolean(audioSettings);

        const shouldDisabledNoiseSupressionCheckbox =
            shouldDisplayAdvancedAudioSettingsCheckboxes && isAudioSettingsEnabled && !noiseSuppressionEnabled;
        ...
        return (
            <div className={classes.container}>
                ...
                {!hideAudioInputPreview && hasAudioPermission && !iAmVisitor && (
                    <AudioInputPreview track={this.props.previewAudioTrack} />
                )}
    ...
    _getSelectors() {
        ...
        const audioInput = {
            ...
            selectedDeviceId: this.props.previewAudioTrack
                ? this.props.previewAudioTrack.getDeviceId()
