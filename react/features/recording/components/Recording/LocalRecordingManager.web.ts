...
import { isMobileBrowser } from '../../../base/environment/utils.any';
import { browser } from '../../../base/lib-jitsi-meet';
import { MEDIA_TYPE } from '../../../base/media/constants';
import { getLocalTrack, getTrackState } from '../../../base/tracks/functions.any';
import { isEmbedded } from '../../../base/util/embedUtils.web';
...
const LocalRecordingManager: ILocalRecordingManager = {
    ...
    async startLocalRecording(store, onlySelf) {
        ...
        if (onlySelf) {
            ...
            this.stream = new MediaStream([...(this.audioDestination?.stream.getAudioTracks() || []), gdmVideoTrack]);
        }
